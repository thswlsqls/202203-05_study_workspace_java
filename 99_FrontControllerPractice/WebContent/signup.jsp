...
<body>
	<div class = "layer">
		<h1 style="text-align: center;">학생 회원가입 페이지</h1>
		
		<form action="controller?cmd=signupAction" method="post">
		<div class = "info">
		학번(아이디)  <input name = "scode" class="in" pattern="\d{8}" placeholder="숫자 8자리 입력"><br>
		이름  <input name = "sname" class="in"><br>
		...
		학년  <input name = "grade" class="in"><br>
		지도교수  <input name = "advisor" class="in" pattern="\d{3}" placeholder="숫자 3자리 입력"><br>
		</div>
		<div class= "info">
		생년월일
		<select name = "year">
