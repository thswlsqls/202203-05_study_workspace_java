...
/**보드 테이블 샘플데이터 */
INSERT INTO 
board(WRITE_NO, WRITER_ID, SUGGESTION_CODE, CONTENTS, SHARE_STATUS, WRITE_DATE) VALUES(WRITE_NO_SEQ.nextval, 'bmh2787', '141', '슬픈 말을 떠올리려 노력했다.'||CHR(13)||CHR(10)|| '스스로를 조금씩 슬픔의 구덩이로 집어넣었다.'||CHR(13)||CHR(10)|| '내가 선택한 고독이란 그런 것이다.', '전체', sysdate);
INSERT INTO
board(WRITE_NO, WRITER_ID, SUGGESTION_CODE, CONTENTS, SHARE_STATUS, WRITE_DATE) VALUES(WRITE_NO_SEQ.nextval, 'bmh2787', '334', '아플 것을 알면서도,'||CHR(13)||CHR(10)|| '나를 던져보기로 했다.'||CHR(13)||CHR(10)|| '첫사랑은 그래서 시큼한 것일까', '전체', sysdate);
INSERT INTO
board(WRITE_NO, WRITER_ID, SUGGESTION_CODE, CONTENTS, SHARE_STATUS, WRITE_DATE) VALUES(WRITE_NO_SEQ.nextval, 'bmh2787', '315', '긴 겨울 끝끝내 견디고,'||CHR(13)||CHR(10)|| '왈칵 쏟는 그것이 아닌,' ||CHR(13)||CHR(10)||'감정을 끝끝내 견디다 천천히 표현하는,'||CHR(13)||CHR(10)|| '그것과 닮아 그대가 좋다.', '전체', sysdate);
INSERT INTO
board(WRITE_NO, WRITER_ID, SUGGESTION_CODE, CONTENTS, SHARE_STATUS, WRITE_DATE) VALUES(WRITE_NO_SEQ.nextval, 'bmh2787', '216', '추억은 사진과 같아.'||CHR(13)||CHR(10)|| '지칠 땐 언제든 꺼내서 볼 수 있잖아.', '전체', sysdate);
INSERT INTO
board(WRITE_NO, WRITER_ID, SUGGESTION_CODE, CONTENTS, SHARE_STATUS, WRITE_DATE) VALUES(WRITE_NO_SEQ.nextval, 'tomboy', '111', '한 줌 재가 돼버릴지언정'||CHR(13)||CHR(10)|| '달려드는,' ||CHR(13)||CHR(10)||'그래야만 더욱 불타오를 수 있는', '전체', sysdate);
INSERT INTO
board(WRITE_NO, WRITER_ID, SUGGESTION_CODE, CONTENTS, SHARE_STATUS, WRITE_DATE) VALUES(WRITE_NO_SEQ.nextval, 'lovedive', '113', '항상 기쁠땐 기쁜 노래만,'||CHR(13)||CHR(10)|| '슬플땐 슬픈 노래만 들려오는 기분이다.'||CHR(13)||CHR(10)|| '세상의 중심은 나니까.', '전체', sysdate);
INSERT INTO
board(WRITE_NO, WRITER_ID, SUGGESTION_CODE, CONTENTS, SHARE_STATUS, WRITE_DATE) VALUES(WRITE_NO_SEQ.nextval, 'hyeonhee', '126', '결국 마지막은 행운이 결정한다.'||CHR(13)||CHR(10)|| '그래서 우리는 단지 최선을 다하고,'||CHR(13)||CHR(10)|| '차분히 그것을 기다리면 되는 것이다.', '전체', sysdate);
INSERT INTO
board(WRITE_NO, WRITER_ID, SUGGESTION_CODE, CONTENTS, SHARE_STATUS, WRITE_DATE) VALUES(WRITE_NO_SEQ.nextval, 'inhyeok', '111', '지친 하루를 버틸 수 있게 해주는' ||CHR(13)||CHR(10)||'그대가 있어 참 다행이다.', '전체', sysdate);
INSERT INTO
board(WRITE_NO, WRITER_ID, SUGGESTION_CODE, CONTENTS, SHARE_STATUS, WRITE_DATE) VALUES(WRITE_NO_SEQ.nextval, 'changi', '116', '그대와 첫 데이트가 생각이 나네요.'||CHR(13)||CHR(10)|| '벚꽃 만개한 석촌호수에 가장 예쁘게 핀 꽃이 그대였어요', '전체', sysdate);
INSERT INTO
board(WRITE_NO, WRITER_ID, SUGGESTION_CODE, CONTENTS, SHARE_STATUS, WRITE_DATE) VALUES(WRITE_NO_SEQ.nextval, 'eunbin', '111', '사랑의 크기를 가늠하는 것은' ||CHR(13)||CHR(10)||'어떠한 태도,말투,표정들에 대한 복합적인 분석이다.', '전체', sysdate);
INSERT INTO
board(WRITE_NO, WRITER_ID, SUGGESTION_CODE, CONTENTS, SHARE_STATUS, WRITE_DATE) VALUES(WRITE_NO_SEQ.nextval, 'eunbin', '126', '내 가장 큰 행운은'||CHR(13)||CHR(10)||'그대를 만나' ||CHR(13)||CHR(10)|| '마주 볼 수 있게 된 것이다.', '전체', sysdate);
INSERT INTO
board(WRITE_NO, WRITER_ID, SUGGESTION_CODE, CONTENTS, SHARE_STATUS, WRITE_DATE) VALUES(WRITE_NO_SEQ.nextval, 'changi', '134', '겨울 끝을 걷는다.' ||CHR(13)||CHR(10)|| '겨울과 봄 그 사이 어느 곳에서'||CHR(13)||CHR(10)|| '우리는 다시 겨울로 걷는다.'||CHR(13)||CHR(10)|| '봄이지만 홀로, 겨울이다.', '전체', sysdate);
INSERT INTO
board(WRITE_NO, WRITER_ID, SUGGESTION_CODE, CONTENTS, SHARE_STATUS, WRITE_DATE) VALUES(WRITE_NO_SEQ.nextval, 'tomboy', '131', '감기에 걸린 것 같다.'||CHR(13)||CHR(10)|| '나은 지 얼마 되지도 않았는데.' ||CHR(13)||CHR(10)||'가볍게 생각했지만 전혀 가볍지 않다.', '전체', sysdate);
INSERT INTO
board(WRITE_NO, WRITER_ID, SUGGESTION_CODE, CONTENTS, SHARE_STATUS, WRITE_DATE) VALUES(WRITE_NO_SEQ.nextval, 'lovedive', '145', '마음이라는 것은'||CHR(13)||CHR(10)||'정말 공들여 예쁘게 접어도'||CHR(13)||CHR(10)|| '스치는 가랑비에'||CHR(13)||CHR(10)|| '와르르 무너지는 것이다.', '전체', sysdate);
INSERT INTO
board(WRITE_NO, WRITER_ID, SUGGESTION_CODE, CONTENTS, SHARE_STATUS, WRITE_DATE) VALUES(WRITE_NO_SEQ.nextval, 'hyeonhee', '144', '그를 함뿍 닮은 너에게 끌렸다.'||CHR(13)||CHR(10)|| '말투,표정,얼굴까지도'||CHR(13)||CHR(10)|| '멀어지는 이유도'||CHR(13)||CHR(10)|| '그와 같을줄은 몰랐었다.', '전체', sysdate);
INSERT INTO
board(WRITE_NO, WRITER_ID, SUGGESTION_CODE, CONTENTS, SHARE_STATUS, WRITE_DATE) VALUES(WRITE_NO_SEQ.nextval, 'inhyeok', '155', '도전엔 늘 두려웠던 적이 없었다'||CHR(13)||CHR(10)||'하지만 어느날 문득'||CHR(13)||CHR(10)||'변화를 꺼리는 나를 발견했다'||CHR(13)||CHR(10)||'언제부터일까?', '전체', sysdate);
INSERT INTO
board(WRITE_NO, WRITER_ID, SUGGESTION_CODE, CONTENTS, SHARE_STATUS, WRITE_DATE) VALUES(WRITE_NO_SEQ.nextval, 'lovedive', '152', '아픔은 나누면 적어진다고'||CHR(13)||CHR(10)|| '누가 그랬어?'||CHR(13)||CHR(10)|| '네 몫까지 두배 세배로'||CHR(13)||CHR(10)|| '더 아픈데 어떡해야할까.', '전체', sysdate);
